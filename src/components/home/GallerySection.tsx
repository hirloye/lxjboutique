...
const galleryImages = [
  { id: 1, src: "/images/gallery/1.webp", alt: "Fairy Frocks", title: "Fairy Frocks", subtitle: "Magical Attire", collectionLabel: "Kids", icon: Wand2 },
  { id: 2, src: "/images/gallery/2.webp", alt: "Luxury Handbags", title: "Luxury Handbags", subtitle: "Premium Accessories", collectionLabel: "Bags", icon: ShoppingBag },
  { id: 3, src: "/images/gallery/3.webp", alt: "Bridal Lehengas", title: "Bridal Lehengas", subtitle: "Shimmering Elegance", collectionLabel: "Bridal", icon: Stars },
  { id: 4, src: "/images/gallery/4.webp", alt: "Designer Kurtis", title: "Designer Kurtis", subtitle: "Comfort Meets Style", collectionLabel: "Kurtis", icon: Feather },
  { id: 5, src: "/images/gallery/5.webp", alt: "Traditional Sarees", title: "Traditional Sarees", subtitle: "Timeless Grace", collectionLabel: "Sarees", icon: Gem },
];
          ...
          {galleryImages.map((img) => {
            ...
            return (
              <div
                ...
                className={`relative rounded-3xl overflow-hidden cursor-pointer transition-all ${isMobile ? "duration-300" : "duration-700"} ease-[cubic-bezier(0.25,1,0.5,1)] flex group bg-neutral-900 ${isActive ? "flex-[10] md:flex-[8]" : "flex-[2] md:flex-[1]"
                  }`}
              >
                ...
                <Image
                  ...
                  priority={img.id === 3}
                  quality={90}
                  className={`object-cover transition-all ${isMobile ? "duration-300" : "duration-700"} ease-[cubic-bezier(0.25,1,0.5,1)] ${isActive ? "opacity-30 blur-xl scale-110" : "opacity-100 scale-100"
                    }`}
                />
                ...
                <Image
                  ...
                  priority={img.id === 3}
                  quality={90}
                  className={`object-cover transition-opacity ${isMobile ? "duration-300" : "duration-700"} ease-[cubic-bezier(0.25,1,0.5,1)] ${isActive ? "opacity-100" : "opacity-0"
                    }`}
                />

                {/* Dark Overlay when inactive for focus */}
                <div
                  className={`absolute inset-0 bg-black/40 transition-opacity ${isMobile ? "duration-300" : "duration-500"} mix-blend-multiply ${isActive ? "opacity-0" : "opacity-100 group-hover:opacity-60"
                    }`}
                />
                ...
                <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition-opacity ${isMobile ? "duration-300" : "duration-500"} flex flex-col justify-end p-6 md:p-8 ${isActive ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                  }`}>
                  <div className={`transition-all ${isMobile ? "duration-300" : "duration-700"} ease-[cubic-bezier(0.25,1,0.5,1)] flex flex-col items-start justify-end h-full ${isActive ? "translate-y-0 delay-100 md:delay-300" : "translate-y-10"
                    }`}>
